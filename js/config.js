 ...
 'index':{
  timecodes:{
   '1':[
    ...
    /*{start:444.46,end:447.4,invoked:false,rem:-40,remText:'Минус 40 секунд'},
   ...
   '2':[
    ...
    {start:3,end:4,invoked:false,vibrate:'two',rem:-30,remText:'Минус полминуты'},
    //{start:3,end:4,invoked:false,vibrate:'two',rem:-30,remText:'Минус полминуты'}
   ]
  },
  preload:{
