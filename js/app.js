...
app.set({dest:'objects.ls',object:'la-storage',lib:false});

if(!localStorage.getItem('la-storage'))
 localStorage.setItem('la-storage',JSON.stringify({points:{},time:[-1,-1,-1,-1]}));
